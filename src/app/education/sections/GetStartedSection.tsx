...
function GettingStartedContent({ inView }: { inView?: boolean }) {
  return (
    <div className="text-center max-w-4xl mx-auto">
      ...
      >
        Get Started with Smarter Institutional Support
      </h2>
      ...
      >
       Solvia helps education institutions automate repetitive queries, respond
instantly, and manage stakeholder communication from one unified dashboard
— strengthening access to quality education.
      ...
      >
       Advancing SDG 4: Enabling inclusive, accessible, and efficient education
systems
      </p>
    </div>
  );
