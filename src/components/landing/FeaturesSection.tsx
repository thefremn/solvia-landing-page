...
function getFeaturesContent() {
  return {
    ...
    cards: {
      ...
      secondary: {
        title: "Built for SMEs & Enterprises",
        description:
          "Enterprise-grade automation designed to stay simple, affordable, and easy for small teams.",
      },
      wide: {
        title: "Unified Dashboard & Knowledge Base",
        description:
          "Manage conversations, agents, and AI knowledge from one real-time control center.",
        image: "/img/chat.png",
      },
    },
  };
